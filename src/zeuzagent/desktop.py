...
def create_icon(size: int = 128) -> QIcon:
    ...
    painter.setBrush(QColor("#19B8DA"))
    painter.setPen(QColor("#19B8DA"))
    painter.drawRoundedRect(4, 4, size - 8, size - 8, 28, 28)
    painter.setPen(QColor("#07131B"))
    font = QFont("Arial", int(size * 0.48), QFont.Black)
    painter.setFont(font)
    painter.drawText(pixmap.rect(), 0x84, "Z")
    painter.end()
    return QIcon(pixmap)
